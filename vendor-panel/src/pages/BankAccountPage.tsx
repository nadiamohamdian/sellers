...
const BankAccountPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Navigate to send documents page
        ...
        <div className="ba-content">
          ...
          <section className="ba-stepper">
            <div className="ba-stepper__item">
              ...
              <span className="ba-stepper__label">آموزش</span>
            </div>
            ...
            <form className="ba-form" onSubmit={handleSubmit}>
                <div className="ba-field">
                  ...
                  <div className="ba-field-input">
                    ...
                    />
                    <img src="/icons/Group 45698.svg" alt="Star" className="ba-field__icon" />
                  </div>
                </div>
                ...
                <div className="ba-field">
                  ...
                  <div className="ba-field-input">
                    ...
                    <img src="/icons/Group 45699.svg" alt="Bank" className="ba-field__icon" />
                  </div>
                </div>
                ...
                <div className="ba-field">
                  ...
                  <div className="ba-field-input">
                    ...
                    />
                    <img src="/icons/Group 45700.svg" alt="User" className="ba-field__icon" />
                  </div>
                </div>
                ...
                <div className="ba-field">
                  ...
                  <div className="ba-field-input">
                    ...
                    />
                    <img src="/icons/Group 45701.svg" alt="Credit Card" className="ba-field__icon" />
                  </div>
                </div>
                ...
                <div className="ba-field">
                  ...
                  <div className="ba-field-input">
                    ...
                    />
                    <img src="/icons/Group 45702.svg" alt="Credit Card" className="ba-field__icon" />
                  </div>
                </div>
                ...
                <div className="ba-field">
                  ...
                  <div className="ba-field-input">
                    <input
                      ...
                      placeholder="IR"
                    />
                    <img src="/icons/Group 45703.svg" alt="Bank Card" className="ba-field__icon" />
                  </div>
                </div>
