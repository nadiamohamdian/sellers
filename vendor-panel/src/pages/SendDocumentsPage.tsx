...
const SendDocumentsPage: React.FC = () => {
  ...
  return (
    <div className="sd-layout">
      {/* Sidebar */}
      <aside className="sd-sidebar sd-sidebar--blurred">
        <div className="sd-sidebar__header">
          <div className="sd-sidebar__avatar">
            <img src="/icons/Group 45650.svg" alt="User" className="sd-sidebar__avatar-icon" />
        ...
        <nav className="sd-sidebar__nav">
          <div className="sd-sidebar__section">
            <h3 className="sd-sidebar__section-title">کالا</h3>
            <ul className="sd-sidebar__list">
              <li className="sd-sidebar__item sd-sidebar__item--active">
                <img src="/icons/Group 45698.svg" alt="Dashboard" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">پیشخوان</span>
              </li>
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45699.svg" alt="Search" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">جستجو و ثبت کالا</span>
              </li>
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45700.svg" alt="Manage" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">مدیریت کالا و افزودن تنوع</span>
              </li>
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45701.svg" alt="Pricing" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">مدیریت تنوع و قیمت گذاری</span>
              </li>
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45702.svg" alt="Inventory" className="sd-sidebar__icon" />
          ...
          <div className="sd-sidebar__section">
            ...
            <ul className="sd-sidebar__list">
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45703.svg" alt="Orders" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">مدیریت سفارشات جاری</span>
              </li>
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45704.svg" alt="History" className="sd-sidebar__icon" />
          ...
          <div className="sd-sidebar__section">
            ...
            <ul className="sd-sidebar__list">
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45705.svg" alt="Invoices" className="sd-sidebar__icon" />
          ...
          <div className="sd-sidebar__section">
            ...
            <ul className="sd-sidebar__list">
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45707.svg" alt="Sales" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">فروش و درآمد</span>
              </li>
              <li className="sd-sidebar__item">
                <img src="/icons/Group 45708.svg" alt="Returns" className="sd-sidebar__icon" />
          ...
          <div className="sd-sidebar__section">
            ...
            <ul className="sd-sidebar__list">
              <li className="sd-sidebar__item">
                <img src="/icons/Vector.svg" alt="Warning" className="sd-sidebar__icon" />
                <span className="sd-sidebar__text">کالاهای غیر مجاز</span>
              </li>
            </ul>
          </div>
          ...
          <div className="sd-sidebar__section">
            ...
            <ul className="sd-sidebar__list">
              <li className="sd-sidebar__item">
                <img src="/icons/Layer_1.svg" alt="Support" className="sd-sidebar__icon" />
